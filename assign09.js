...
function getCities()
{
    ...
    // Declare and initialize cityTxt variable.
    var cityTxt = 0;
    // Set cityTxt variable to case or default.
...
function validateFileName(fileName)
{
    ...
    { 
        document.getElementById('parseJSON').style.border = 'thin solid lightgrey';
    } 
    else
    {   
        document.getElementById('parseJSON').value = 'Invalid File Name';
        document.getElementById('parseJSON').style.border = 'thin solid red';
    }
}
...
function getStudents()
{
    ...
    xhttpStudents.onreadystatechange =
            function ()
            {
                ...
                {
                   /* var dataString = this.responseText;
                    var parseStudent = JSON.parse(dataString);*/
